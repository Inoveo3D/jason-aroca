...
export const metadata: Metadata = {
  title: "Électricien & Multi-services Marignane — Dépannage, Placo, Menuiserie | + élect Jason Aroca",
  description:
    "+ élect, votre artisan à Marignane (13700) : électricité, dépannage 7j/7, installation, mise aux normes, mais aussi multi-services (placo, fenêtres, portails, volets). Assurance décennale. Devis gratuit. Intervient à Vitrolles, Rognac, Martigues, Aix-en-Provence, Marseille et alentours.",
  keywords: [
    ...
    "remplacement portail Marignane",
    "remplacement volets Marignane",
  ...
  openGraph: {
    title: "Électricien & Multi-services à Marignane — + élect | Jason Aroca",
    description: "Dépannage électrique urgent, installation, placo, fenêtres, portails et volets à Marignane. Devis gratuit, 7j/7, assurance décennale.",
  },
};
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden pt-20">
        <Image src="/images/background.webp" alt="" fill className="object-cover opacity-20" priority aria-hidden="true" />
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-brand-900 opacity-85" />

        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white">
          <span className="inline-block bg-brand-500 text-white text-sm font-semibold px-4 py-1 rounded-full mb-6">
            Électricien — Marignane & alentours
          </span>

          <h1 className="text-4xl md:text-6xl font-light leading-tight mb-6">
            + Élect - Jason Aroca{" "}
            <span className="text-brand-400 block mt-1">Votre Artisan Multiservices</span>
          </h1>

          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10">
            Entrepreneur individuel spécialisé en électricité et multi-services à Marignane.
            Dépannage disponible 7j/7 de 7h30 à 18h30 — interventions le samedi et dimanche sur urgences uniquement.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-brand-500 hover:bg-brand-600 text-white font-bold text-lg px-8 py-4 rounded-xl transition-all hover:scale-105 shadow-lg"
            >
              Demander un devis gratuit
            </Link>
            <a
              href="tel:+33698127982"
              className="border-2 border-white hover:border-brand-400 hover:text-brand-400 text-white font-bold text-lg px-8 py-4 rounded-xl transition-all flex items-center justify-center gap-2"
            >
          ...
          <p className="mt-6 text-brand-400 font-semibold animate-pulse">
      ...
      <section className="py-20 bg-gray-50" id="services">
        <div className="max-w-6xl mx-auto px-4">
            ...
            {services.map((s) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1 gap-3">
                  <h3 className="font-bold text-brand-400 text-lg">{s.title}</h3>
          ...
          <div className="text-center mt-10">
            <Link
              href="/services"
              className="inline-block border-2 border-brand-500 text-brand-600 hover:bg-brand-500 hover:text-white font-semibold px-8 py-3 rounded-xl transition-all"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative w-full max-w-sm mx-auto md:mx-0 h-80 md:h-auto md:aspect-[3/4] rounded-2xl overflow-hidden shadow-lg">
            <Image
              ...
              alt="Jason Aroca artisan multiservices"
              fill
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Avec plus de 15 ans d'expérience, Jason Aroca est un artisan polyvalent
              spécialisé en électricité résidentielle et tertiaire, mais aussi dans les
              travaux multi-services : pose de placo, second œuvre et travaux complémentaires.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              Basé à Marignane, il intervient dans tout le secteur des Bouches-du-Rhône
              pour un service clé en main — de l'installation électrique à la finition —
              avec des solutions adaptées à votre budget.
            </p>
            <ul className="space-y-2 mb-8">
              {["Devis gratuit", "Garantie décennale (installations)", "Électricité & multi-services", "Tarifs transparents"].map((item) => (
