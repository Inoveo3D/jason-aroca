      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <span className="font-bold text-xl text-white">
              + <span className="text-brand-400">élect</span>
            </span>
          </div>
        ...
        <div className="hidden md:block md:pl-44">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/contact" className="hover:text-brand-400 transition-colors">Contact & Devis</Link></li>
          </ul>
        </div>
        ...
        <div className="md:pl-28">
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+33698127982" className="hover:text-brand-400 transition-colors">
                06 98 12 79 82
              </a>
            </li>
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:aroca.jason.elect@outlook.fr" className="hover:text-brand-400 transition-colors">
